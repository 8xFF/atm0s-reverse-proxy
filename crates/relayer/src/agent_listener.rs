...
pub trait AgentConnection<S: AgentSubConnection<R, W>, R: AsyncRead + Unpin, W: AsyncWrite + Unpin>: Send + Sync {
...
#[async_trait::async_trait]
pub trait AgentListener<C: AgentConnection<S, R, W>, S: AgentSubConnection<R, W>, R: AsyncRead + Unpin, W: AsyncWrite + Unpin>: Send + Sync {
